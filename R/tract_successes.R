#' Extract successful Census tract identification results
#'
#' Returns records that were successfully assigned to Census tracts by
#' [id_tract()].
#'
...
#'
#' @export
tract_successes <- function(x) {
    check_tract_result(x)

    filter_status(x, ".tract_identified", TRUE)
}
